...
//    QXmlStreamWriter xmlWriter(&array);
    ...
    m_xmlWriter.writeStartElement( m_tds, "Analytics" );
    ...
    m_xmlWriter.writeStartElement( m_tds, "System" );
    ...
    m_xmlWriter.writeStartElement( m_tds, "SupportedVersions" );
    ...
    m_xmlWriter.writeStartElement( m_tds, "IO" );
    ...
    m_xmlWriter.writeStartElement( m_tds, "Security" );
    ...
    m_xmlWriter.writeStartElement( m_tds, "Events" );
    ...
    m_xmlWriter.writeStartElement( m_tds, "Imaging" );
    ...
    m_xmlWriter.writeStartElement( m_tds, "Media" );
    m_xmlWriter.writeTextElement(m_tt, "XAddr", "http://" + m_hostAddress.toString() + "/onvif/media_service");
    m_xmlWriter.writeStartElement( m_tds, "StreamingCapabilities" );
    ...
    m_xmlWriter.writeStartElement( m_tds, "PTZ" );
